...
<div className="space-y-4">
            ...
            <h2 className="text-2xl text-blue-600 font-semibold">${product.price}</h2>
            <p className="text-gray-700">{product.description}</p>
         
         <p className={`font-medium ${product.inventory > 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <div className="flex item-center gap-2">
            ...
            disabled={productOutOfStock}className="w-10 h-10 rounded-md bg-gray-200 hover:bg-gray-300 disabled:opacity-50 text-xl"
                >
                  -
